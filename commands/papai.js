...
jimp.read("https://i.imgur.com/g2O45zA.png").then(function(image){
   if(args < 1 )
    return message.reply("Escreva algo, bebê")
   
   jimp.loadFont(jimp.FONT_SANS_32_BLACK).then(function(font){
          
    image.print(font, 55, 325, args.join(' '), 400)
                            ...
                            newMessage.edit('**<:5_:374704170571137026> | Aguarde...**').then(newMessage => {
                                newMessage.edit('**<:6_:374704171020058634> | Aguarde...**').then(newMessage => {
                                    newMessage.edit('**<:7_:374704170600497163> | Aguarde...**').then(newMessage => {
                                        ...
                                        message.channel.sendFile(buffer, 'papai.jpg');
                                                            })
                                                        })
                                                    })
                                                })
...
.setDescription(`${message.author.username} usou o comando 'c!papai'`)
.setColor(0xd34d4d)
